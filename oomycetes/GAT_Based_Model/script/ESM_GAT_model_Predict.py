...
def predict_esm_gat(csv_file, npy_file, output_file):
    ...
    model_paths = [
        "./oomycetes/GAT_Based_Model/esm2_GAT_kf_model/ESM2_GAT_distance_9_fold_1.h5",
        "./oomycetes/GAT_Based_Model/esm2_GAT_kf_model/ESM2_GAT_distance_9_fold_2.h5",
        "./oomycetes/GAT_Based_Model/esm2_GAT_kf_model/ESM2_GAT_distance_9_fold_3.h5",
        "./oomycetes/GAT_Based_Model/esm2_GAT_kf_model/ESM2_GAT_distance_9_fold_4.h5",
        "./oomycetes/GAT_Based_Model/esm2_GAT_kf_model/ESM2_GAT_distance_9_fold_5.h5"
    ]
